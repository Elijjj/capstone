...
export class ProductsService {
    ...
    this.httpClient
      ...
      .subscribe((transformedProductData) => {
        this.updateProductList(
          transformedProductData.products,
          transformedProductData.maxProducts
        );
      });
  }
  ...
  addProduct(
    ...
    this.httpClient
      .post<{ message: string; products: Products }>(BACKEND_URL, productData)
      .subscribe((response) => {
  ...
  updateProduct(
    ...
    this.httpClient.put(BACKEND_URL + id, productData).subscribe((response) => {
      this.router.navigate(['/admin/products']);
    });
  }
