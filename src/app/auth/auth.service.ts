...
getUserProfileDiscount(userId: string) {
  ...
  //     } else {
  //         // Here, you need to handle the conversion from string to Date for the AuthData.birthday property
  //         authData = {
  //             id: id,
  //             email: email,
  //             password: password,
  //             firstname: firstname,
  //             lastname: lastname,
  //             imagePath: typeof image === 'string' ? image : '', // default to empty string if not a string
  //             contactnumber: contactnumber,
  //             city: city,
  //             province: province,
  //             bls: bls,
  ...
  //             postalcode: postalcode,
  //             role: role,
  //             birthday: birthday instanceof Date ? birthday : new Date(birthday), // Convert string to Date or use the Date as is
  //             discountType: discountType
  //         };
  //     }
  //     this.http.put(BACKEND_URL + 'profile/discount/' + id, authData)
  //     .subscribe(response => {
  //         this.router.navigate(["/profile/discount", id]);
  //     });
  // }
